...
if (!isset($_COOKIE['site_version']) && $detect->isMobile() && !isMobileVersion()) {
...
elseif (isset($_COOKIE['site_version']) && $_COOKIE['site_version'] == 'mobile' && $detect->isMobile() && !isMobileVersion()) {
	header('Location: http://m.vsekroham.ru'.$_SERVER['REQUEST_URI']);
	exit;
}
