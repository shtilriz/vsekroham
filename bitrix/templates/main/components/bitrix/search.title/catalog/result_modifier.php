...
$arParams['PRICE_VAT_INCLUDE'] = false;
...
if (!empty($arResult["ELEMENTS"]) && CModule::IncludeModule("iblock"))
{
	...
	$arResult["PRICES"] = CIBlockPriceTools::GetCatalogPrices(false, array('BASE'));
	...
	{
		$arElement["PRICES"] = CIBlockPriceTools::GetItemPrices($arElement["IBLOCK_ID"], $arResult["PRICES"], $arElement, false, array());
