...
<div id="catalog-section" class="stuff-list-container" data-navrecordcount="<?=$arResult["NAV_RESULT"]->NavRecordCount?>" data-navpagesize="<?=$arResult["NAV_RESULT"]->NavPageSize?>" data-code="<?=$arParams["SECTION_CODE"]?>" itemscope itemtype="http://schema.org/ItemList">
	...
	<ul class="stuff-list">
		...
		foreach ($arResult["ITEMS"] as $key => $arItem) {
			...
			echo getProductHTML2Section($arItem, $strMainID);
		}
		if($_SERVER['HTTP_X_REQUESTED_WITH']=='XMLHttpRequest') {
